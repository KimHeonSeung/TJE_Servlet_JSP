...
import pro.service.MyPageService;

public class MyPageCommand extends Command {
	private String formPage = "/WEB-INF/forms/mypage.jsp";
	private String submitPage = "/WEB-INF/submits/mypage.jsp";
	private String errorPage = "/WEB-INF/errors/mypage.jsp";

	private MyPageService lService = new MyPageService();
