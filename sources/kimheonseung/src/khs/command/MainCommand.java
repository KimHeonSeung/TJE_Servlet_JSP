...
public class MainCommand extends Command {
	...
	protected String processForm(HttpServletRequest request, HttpServletResponse response) {
		...
		try (Connection conn = ConnectionProvider.getConnection()) {
			...
			HashMap<Integer, HashMap<Integer, Object>> boardAndCommentCount = new HashMap<Integer, HashMap<Integer, Object>>();
			...
			for(Board_Info bi : boardList) {
				...
				HashMap<Integer, Object> articleNumAndCommentMap = (HashMap<Integer, Object>)articleNumAndCommentResultMap.get("articleNumAndCommentMap");
				
				boardAndCommentCount.put(board_id, articleNumAndCommentMap);
				
			}
			
			request.setAttribute("boardAndCommentCount", boardAndCommentCount);
			request.setAttribute("boardList", boardList);
			request.setAttribute("everyRecentBoard", everyRecentBoard);
			
			application.setAttribute("boardList_App", boardList);
