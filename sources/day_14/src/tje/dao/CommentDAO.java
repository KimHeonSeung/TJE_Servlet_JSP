...
public class CommentDAO {
	...
	public Comment selectComment(Connection conn, Comment obj) {
		Comment result = null;
	...
	public ArrayList<Comment> selectCommentByMemberId(Connection conn, Member obj) {
		ArrayList<Comment> result = new ArrayList<Comment>();
		String sql = "select * from comment where member_id=? order by comment_id desc limit 5";
		PreparedStatement pstmt = null;
		ResultSet rs = null;
